            ...
            <ul class="d-none d-md-inline-block navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        ...
                        <a class="dropdown-item" href="/myapp/member/register">회원가입</a>
                        <a class="dropdown-item" href="/myapp/member/modify">회원정보</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="/myapp/member/logout">로그아웃</a>
                    </div>
                </li>
            </ul>
        </nav>
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                ...
                                <a class="nav-link" href="/myapp/member/register">회원가입</a>
                                <a class="nav-link" href="/myapp/member/modify">회원정보</a>
                                <a class="nav-link" href="/myapp/member/logout">로그아웃</a>
                            </nav>
                            </div>
